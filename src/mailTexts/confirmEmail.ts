export const confirmEmailHtml = (link: string): string => {
  return `
    <div style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
      <img style="width: 3rem; height: 3rem; margin: 10px 0;"
      ...
      <div
        style="display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 20px; border-radius: 5px; border: 1px solid #ccc;">
        <div style="font-size: 1rem; font-weight: bold;">IFELFI email address confirm</div>
        <div style="margin: 1rem 0;">Click the button below to confirm your email address</div>
        <a href="${link}"
          style="padding: 10px 20px; background-color: #ff731c; color: #fff; text-decoration: none; font-size: 1rem; font-weight: bold; border-radius: 5px;">Confirm
          email</a>
      </div>
    </div>
  `;
